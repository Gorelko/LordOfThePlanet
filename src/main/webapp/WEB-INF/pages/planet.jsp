...
<table border="1" align="center">
    <tr>
        <td>Название планеты</td>
        <td>Кнопка</td>
    </tr>

    <tr>
        <td><input name="enterData2" type="text" id="namePlanet" class="input" placeholder="Введите имя планеты"></td>
        <td>
            <button type="button" id="button" onclick="myFunction()">Создать планету</button>
        </td>
    </tr>
</table>
<br>
...
<script language="JavaScript" type="text/javascript">
    function myFunction() {
        ...
        var url = "http://localhost:8080/planet/name=" + namePlanet;
        ...
        ajax.onreadystatechange = function () {
            ...
            if (ajax.readyState == 4 && (ajax.status == 200)) {
                ...
                var inPage = '';
                inPage = '<tr><td>Название планеты</td></tr>';
                for (var i = 0; i < planetArr.length; i++) {
                    inPage += '<tr>' + '<td>' + planetArr[i].split("\"name\":")[1].split(",\"")[0].replace("\"", "").replace("\"", "") + '</td>' + '</tr>';
                }
